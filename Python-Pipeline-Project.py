...
#move sleuth file to newly made directory
sleuth_r_path = Path('Sleuth.R').absolute() #path to reference trancriptome
new_spot = Path("PipelineProject_Devinjeet_Saini").absolute()
new_spot = f'{new_spot}/Sleuth.R'
os.rename(sleuth_r_path,new_spot)
...
tpm_output = ['D1-2DPI','D1-6DPI','D3-2DPI','D3-6DPI']
...
with open ('PipelineProject.log','a') as f: #open log file and add headers row for differentiation values
  f.write('\n')
